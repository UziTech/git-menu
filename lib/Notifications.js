...
export const NotificationsConfig = {
	default: CONFIG_YES,
	enum: [
		{value: CONFIG_YES, description: "Simple"},
		{value: CONFIG_NO, description: "None"},
		{value: CONFIG_ONLY_ERROR, description: "Only Errors"},
		{value: CONFIG_GIT, description: "Git Output"},
		{value: CONFIG_GIT_VERBOSE, description: "Verbose Git Output"},
	],
};
