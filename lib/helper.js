...
export default {
	...
	async gitLockExists(root, git) {
		...
		const removeLock = atom.confirm({
			message: "Another git process seems to be running in this repository, do you want to remove the lock file?",
			detailedMessage: "You are deleting:\n" + lockPath,
			buttons: {
				"Remove git lock": _ => true,
				"Cancel": _ => false,
			}
		});
