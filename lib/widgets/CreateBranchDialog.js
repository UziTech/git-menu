...
export default class CreateBranchDialog extends Dialog {
	...
	buttons() {
		return (
			<div>
				<button className="native-key-bindings" tabIndex="4" onclick={this.accept} disabled={this.state.fetching}>
					<i className="icon branch"></i>
					<span>Create Branch</span>
				</button>
				<button className="native-key-bindings" tabIndex="5" onclick={this.fetch} disabled={this.state.fetching}>
					<i className="icon sync"></i>
					<span>Fetch</span>
				</button>
				<button className="native-key-bindings" tabIndex="6" onclick={this.cancel}>
