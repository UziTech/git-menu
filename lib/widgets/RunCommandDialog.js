		...
		return (
			<div>
				...
				<label className="input-label">
					...
					<Autocomplete items={this.state.recentItems} maxItems="10"  ref="commandInput" tabIndex={ this.state.files.length + 1 } value={this.state.command} onChange={this.commandChange} />
				</label>
			</div>
		);
	}
