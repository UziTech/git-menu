...
export default class Dialog {
	...
	render() {
		...
		const titleClass = title.toLowerCase().replace(/\W/g, "-");

		return (
			<div className={`dialog context-git ${titleClass}`} onkeyup={this.keyup}>
				<div className="heading">
					<i className="icon icon-x clickable" onclick={this.cancel}></i>
