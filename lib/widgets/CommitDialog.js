...
export default class CommitDialog extends Dialog {
	...
	buttons() {
		return (
			<div>
				<button className="native-key-bindings" tabIndex={this.state.files.length + 3} onclick={this.accept}>
					<i className="icon commit"></i>
					<span>Commit</span>
				</button>
				<button className="native-key-bindings" tabIndex={this.state.files.length + 4} onclick={this.pushClick}>
					<i className="icon push"></i>
					<span>Commit & Push</span>
				</button>
				<button className="native-key-bindings" tabIndex={this.state.files.length + 5} onclick={this.pushPullClick}>
					<i className="icon pull"></i>
					<span>Commit & Push & Pull</span>
				</button>
				<button className="native-key-bindings" tabIndex={this.state.files.length + 6} onclick={this.cancel}>
