...
describe("commit-staged", function () {
	...
	describe("commit", function () {
		...
		it("should return '1 File committed.'", async function () {
			const ret = await commitStaged.command(this.filePaths, statusBar, this.git, Notifications, this.dialog);
